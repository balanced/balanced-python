...
print("Our secret is: %s" % api_key.secret)

print("configure with our secret %s" % api_key.secret)
...
print("what's my merchant?, easy: Merchant.me: %s" % balanced.Merchant.me)
